...
\begin{corollary} By \referToDefinition{shape}, given a variable
...
\begin{corollary} Consider any pair of clauses $c_1=\left\langle v_1,p_1,x_1
...
By \referToDefinition{unary-clause}, all clauses are unary, and hence a clause
can be said to specify a shape. By \referToDefinition{function-tuple}, a
