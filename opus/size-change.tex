...
devised to traverse the graph and deduce certain properties, such as e.g.
reoccurring primitive operations on otherwise static variables\cite{kildall}.
...
ended in more than one way. For reasons that will become apparent in a bit, we
chose to disregard start and end nodes completely.
