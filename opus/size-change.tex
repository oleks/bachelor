...
participation of $x$ in the same kind of relations as $a$ and the participation
of $y$ in the same kind of relations as $b$ does not alone indicate their
respective equivalence, since the actual property that $v\equiv\textt{a.b}$ is
lost.
...
and some kind of ``abstract patterns''.
...
is simply \mono{right} with the variable space consisting merely of the
