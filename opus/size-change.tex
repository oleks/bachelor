...
The simplest case is when the abstract pattern $p^s$ is simply \mono{0}, or
...
If $p^d$ is the name pattern $n^d$, this has a more complex effect. First, if
...
\refer{eq:sct-pattern-source-fail}) then the values of the corresponding
