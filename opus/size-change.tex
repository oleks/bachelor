...
destination variables that might appear in the corresponding $p^d$. Hence,
$\phi$ need not be modified.
...
any name $n^d$, that is, it is \mono{\_} or \mono{0}. This pattern contains no
